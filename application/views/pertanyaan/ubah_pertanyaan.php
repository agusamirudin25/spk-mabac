                        ...
                        <form method="POST" action="" class="form-custom">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" readonly class="form-control" id="kode" name="pertanyaan" value="<?= $pertanyaan['kode']; ?>">
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="<?= base_url('pertanyaan/kuesioner'); ?>"><button type="button" class="btn btn-danger btn-md ml-4"><i class="fas fa-undo"></i>&nbsp; Batal</button></a>
                                </div>
                        </form>
                    </div>
                    <!-- /.card -->
