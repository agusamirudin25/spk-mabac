                    ...
                    <div class="card">
                        <div class="card-header bg-teal">
                            <div class="card-tools">
                                <form class="form-inline" action="<?= base_url('user/cari_karyawan'); ?>" method="POST">
                                    <div class="input-group input-group-sm" style="width: 185px;">
                                        <input type="text" id="keyword" name="keyword" class="form-control float-right" placeholder="Cari Berdasarkan Nama">
