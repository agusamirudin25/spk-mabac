                                    ...
                                    <?php if ($karyawan->num_rows() > 0) : ?>
                                        <?php foreach ($karyawan->result_array() as $kar) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('keputusan/tambah_penilaian/' . $kar['nik']); ?>"><button type="button" class="btn btn-sm btn-success"><i class="fas fa-user-edit"></i>&nbsp; Nilai sekarang</button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
                                    ...
                                    <?php if ($keputusan->num_rows() > 0) : ?>
                                        <?php foreach ($keputusan->result_array() as $kep) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('keputusan/ubah_penilaian/' . $kep['kode']); ?>"><button type="button" class="btn btn-sm btn-info ml-2"><i class="fas fa-user-edit"></i>&nbsp; Ubah Penilaian</button></a>
