                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('admin/tambah_karyawan'); ?>"><button type="button" class="btn btn-sm btn-info"><i class="fas fa-user-plus"></i>&nbsp; Tambah Karyawan</button></a>
                                    ...
                                    <?php if ($karyawan->num_rows() > 0) : ?>
                                        <?php foreach ($karyawan->result_array() as $kar) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/ubah_karyawan/' . $kar['nik']); ?>"><button type="button" class="btn btn-sm btn-success"><i class="fas fa-user-edit"></i>&nbsp; Ubah</button></a>
                                                    <a href="<?= base_url('admin/hapus_karyawan/' . $kar['nik']); ?>"><button type="button" class="btn btn-sm btn-danger ml-2" onclick="return confirm('Apakah data ini akan dihapus?');"><i class="far fa-trash-alt"></i>&nbsp; Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
