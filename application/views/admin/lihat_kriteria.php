                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('admin/tambah_kriteria'); ?>"><button type="button" class="btn btn-sm btn-info"><i class="fas fa-user-plus"></i>&nbsp; Tambah Kriteria</button></a>
                            <div class="card-tools">
                                <form class="form-inline" action="<?= base_url('admin/cari_kriteria'); ?>" method="POST">
                                    ...
                                    <?php if ($criteria->num_rows() > 0) : ?>
                                        <?php foreach ($criteria->result_array() as $criteria) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/detail_kriteria/' . $criteria['kode']); ?>"><button type="button" class="btn btn-sm btn-info"><i class="far fa-eye"></i></i>&nbsp; Detail</button></a>
                                                    <a href="<?= base_url('admin/ubah_kriteria/' . $criteria['kode']); ?>"><button type="button" class="btn btn-sm btn-success ml-2"><i class="fas fa-user-edit"></i>&nbsp; Ubah</button></a>
                                                    <a href="<?= base_url('admin/hapus_kriteria/' . $criteria['kode']); ?>"><button type="button" class="btn btn-sm btn-danger ml-2" onclick="return confirm('Apakah data ini akan dihapus?');"><i class="far fa-trash-alt"></i>&nbsp; Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    <?php else : ?>
