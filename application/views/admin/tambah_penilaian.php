                    ...
                    <div class="card card-primary">
                        ...
                        <form method="POST" action="" class="form-custom">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>C01</label>
                                    <input type="text" class="form-control" id="c01" name="c01" placeholder="Nama" value="<?= set_value('c01'); ?>">
                                    <?= form_error('c01', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label>C02</label>
                                    <input type="text" class="form-control" id="c02" name="c02" placeholder="Nama" readonly value="<?= $nilaic02 ?>">
                                    <?= form_error('c02', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label>C03</label>
                                    <input type="text" class="form-control" id="c03" name="c03" placeholder="Nama" value="<?= set_value('c03'); ?>">
                                    <?= form_error('c03', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label>C04</label>
                                    <input type="text" class="form-control" id="c04" name="c04" placeholder="Nama" value="<?= set_value('c04'); ?>">
                                    <?= form_error('c04', '<small class="text-danger">', '</small>'); ?>
                                </div>
                                <div class="form-group">
                                    <label>C05</label>
                                    <input type="text" class="form-control" id="c05" name="c05" placeholder="Nama" value="<?= set_value('c05'); ?>">
