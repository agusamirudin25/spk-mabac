                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="<?= base_url('admin/tambah_user'); ?>"><button type="button" class="btn btn-sm btn-info"><i class="fas fa-user-plus"></i>&nbsp; Tambah Pengguna</button></a>
                            <div class="card-tools">
                                <form class="form-inline" action="<?= base_url('admin/cari_user') ?>" method="POST">
                                    ...
                                    <?php if ($users->num_rows() > 0) { ?>
                                        <?php foreach ($users->result_array() as $user) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?= base_url('admin/ubah_user/' . $user['nik']); ?>"><button type="button" class="btn btn-sm btn-success"><i class="fas fa-user-edit"></i>&nbsp; Ubah</button></a>
                                                    <a href="<?= base_url('admin/hapus_user/' . $user['username']); ?>"><button type="button" class="btn btn-sm btn-danger ml-2" onclick="return confirm('Apakah data ini akan dihapus?');"><i class="far fa-trash-alt"></i>&nbsp; Hapus</button></a>
                                                </td>
                                            </tr>
                                        <?php endforeach;
                                    } else { ?>
